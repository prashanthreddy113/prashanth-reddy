...
import com.manabandi.rider.ui.theme.ManaBandiTheme
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val app = application as ManaBandiApplication

        // On Android 13+ AppCompatDelegate.setApplicationLocales needs an attached
        // Activity, so the call made in ManaBandiApplication is a no-op there.
