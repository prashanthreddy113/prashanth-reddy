...
import com.manabandi.rider.ui.components.LocalSpeech
...
val languageOptions = listOf(
    LanguageOption("te", "తెలుగు", "నమస్తే! మన బండికి స్వాగతం."),
    LanguageOption("en", "English", "Hello! Welcome to Mana Bandi."),
    LanguageOption("hi", "हिंदी", "नमस्ते! मन बंडी में आपका स्वागत है।"),
    LanguageOption("kn", "ಕನ್ನಡ", "ನಮಸ್ಕಾರ! ಮನ ಬಂಡಿಗೆ ಸ್ವಾಗತ."),
    LanguageOption("mr", "मराठी", "नमस्कार! मन बंडी मध्ये स्वागत आहे."),
    LanguageOption("ur", "اردو", "السلام علیکم! منا بنڈی میں خوش آمدید۔")
)
